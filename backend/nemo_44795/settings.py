"""
Django settings for nemo_44795 project.
...
WSGI_APPLICATION = 'nemo_44795.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nemo_44795 API",
    "DESCRIPTION": "API documentation for nemo_44795 App",
    "VERSION": "v1",
}
